...
def createTableIfNotExists(tableName, cur):
  ...
  createTable = '''declare
    ...
    begin
      ...
      if c = 0 then
          execute immediate 'CREATE TABLE {1}(aclob clob)';
      end if;
    end;'''.format(tableName, tableName)
  cur.execute(createTable)

def insertClob(tableName, clob, cur):
  """
